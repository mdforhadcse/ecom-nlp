# evaluate_fw_performance.py
# Usage:
#   python evaluate_performance.py
#
# Inputs (relative to project root):
#   - gold/dataset_final_selected_processed_part.csv
#   - fireworks/dataset_final_selected_fireworks_processed_20260104-231510.csv
# Output directory:
#   - reports/
#
# Notes:
# - This treats absa_* as reference (pseudo-gold).
# - Triplet scoring is set-based micro P/R/F1.
# - Includes a "coarse category" scoring mode to reduce penalty when model outputs parent aspect categories.
